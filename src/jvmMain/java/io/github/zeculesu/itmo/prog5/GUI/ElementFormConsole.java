...
import static io.github.zeculesu.itmo.prog5.client.ElementFormConsole.checkCoordinates;
...
public class ElementFormConsole {
    ...
    public static Coordinates checkCoordinatesY(String input, Coordinates cord) throws InputFormException {
    ...
    public static Coordinates checkCoordinatesX(String input, Coordinates cord) throws InputFormException {
        if (input == null || input.isBlank() || input.isEmpty()) throw new InputFormException("Неправильный ввод координат");
